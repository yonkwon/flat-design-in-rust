        ...
        params::PARAMS_INDEX_COMBINATIONS.get().unwrap().into_par_iter().for_each(
            ...
            for _ in 0..params::ITERATION {
                ...
                for t in 0..params::TIME {
                    ...
                    local_cent.accumulate(t, scenario.overall_centralization);
                    local_cent_rr.accumulate(t, scenario_random_rewiring.overall_centralization);
                    local_cent_nr.accumulate(t, scenario_no_rewiring.overall_centralization);
                    local_cent_12.accumulate(t, scenario.overall_centralization - scenario_random_rewiring.overall_centralization);
